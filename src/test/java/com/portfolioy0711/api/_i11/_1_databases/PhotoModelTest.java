...
public class PhotoModelTest {
    ...
    public void saveTest() {
        ...
        assertArrayEquals(photoModel.fetchPhotos().toArray(), new Photo[] { new Photo("e4d1a64e-a531-46de-88d0-ff0ed70c0bb8", review), new Photo("afb0cef2-851d-4a50-bb07-9cc15cbdc332", review) } );
    }
}
